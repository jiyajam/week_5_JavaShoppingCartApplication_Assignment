# Use JDK 17 as per your compiler target in the logs
FROM eclipse-temurin:17-jdk

WORKDIR /app

# Install dependencies for JavaFX on Linux
RUN apt-get update && apt-get install -y wget unzip libgl1-mesa-glx libgtk-3-0 libglu1-mesa && \
